     ...
     <div class="panel panel-default">
      ...
      <?php
        $noDomainsDisabledClass = count($domains) == 0 ? 'disabled' : '';
        $noHostingsDisabledClass = count($hostings) == 0 ? 'disabled' : '';
        $noWebsitesDisabledClass = count($websites) == 0 ? 'disabled' : '';
        $noSocialMediasDisabledClass = count($socialMedias) == 0 ? 'disabled' : '';
        $noneDisabledClass = ($noDomainsDisabledClass == 'disabled' && $noHostingsDisabledClass == 'disabled' && $noSocialMediasDisabledClass == 'disabled') ? 'disabled' : '';
      ?>
     	<div class="panel-body">
     		...
     		<div class="dashboard-icon <?php echo $noDomainsDisabledClass; ?>">
     		...
     		<div class="dashboard-icon <?php echo $noHostingsDisabledClass; ?>">
     		...
     		<div class="dashboard-icon  <?php echo $noneDisabledClass; ?>">
     		...
     		<div class="dashboard-icon <?php echo $noWebsitesDisabledClass; ?>">
...
$(document).ready(function() {
   $(".dashboard-icon.disabled a").click(function() {
     return false;
   });
});
</script>
