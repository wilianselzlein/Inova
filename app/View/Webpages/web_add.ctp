<div class="panel panel-default">
 <div class="panel-heading">
   <h3>
    <span class="fa fa-file-text"></span> <?php echo __('Add').' '.__('Webpage'); ?>
  ...
  <div class="form-group">    
    <?php
      if(isset($websiteDefaults)){
        echo $this->Form->input('website_id', array('class' => 'form-control', 'disabled' => true,'div'=> array('class'=>'col-sm-12')));
        echo $this->Form->hidden('website_id', array('value' => $websiteDefaults['id']));
      }else{
        echo $this->Form->input('website_id', array('class' => 'form-control', 'div'=> array('class'=>'col-sm-12')));
      }
    ?>
  </div><!-- .form-group -->
  <div class="form-group">
