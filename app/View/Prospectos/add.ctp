<div class="panel panel-default">
    <div class="panel-heading">
        <h3>
            <span class="fa fa-odnoklassniki"></span> <?php echo __('Add').' '.__('Prospecto'); ?>               
    ...
    <div class="panel-body">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <?php echo $this->Form->hidden('user_id', array('class' => 'form-control', 'value' =>AuthComponent::user('id'))); ?>
            </div><!-- .form-group -->
