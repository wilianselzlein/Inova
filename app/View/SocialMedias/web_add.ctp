<div class="panel panel-default">
	<div class="panel-heading">
		<h3>
			<span class="fa fa-share-alt"></span> <?php echo __('Add').' '.__('SocialMedia'); ?>
	...
	<div class="panel-body">
		...
		<fieldset>
			<div class="form-group">
				<?php echo $this->Form->input('customer_id', array('class' => 'form-control combobox', 'value'=> $cid, 'disabled' => isset($cid),'empty'=>true, 'div'=> array('class'=>'col-sm-12'))); ?>
			</div><!-- .form-group -->
			<div class="form-group">
