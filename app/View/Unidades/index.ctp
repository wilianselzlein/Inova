<div class="unidades index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $unidade['Unidade']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $unidade['Unidade']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $unidade['Unidade']['id']), null, __('Are you sure you want to delete # %s?', $unidade['Unidade']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
