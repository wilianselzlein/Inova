                ...
                <table class="table table-striped table-bordered">
                    <tbody>
                        <tr>		<td><strong><?php echo __('Id'); ?></strong></td>
                            ...
                            <td>
                                <?php echo $this->Time->i18nFormat($historico['Historico']['datainicial'], $this->Html->__getDateTimeFormatView()); ?>&nbsp;
                            </td>
                        </tr><tr>		<td><strong><?php echo __('Datafinal'); ?></strong></td>
                            <td>
                                <?php echo $this->Time->i18nFormat($historico['Historico']['datafinal'], $this->Html->__getDateTimeFormatView()); ?>&nbsp;
