...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-9">
		...
		<div class="subgrupos index">
		
			<h2><?php echo __('Subgrupos'); ?></h2>
...
<?php foreach ($subgrupos as $subgrupo): ?>
	<tr>
		<td><?php echo h($subgrupo['Subgrupo']['id']); ?>&nbsp;</td>
		<td><?php echo h($subgrupo['Subgrupo']['nome']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($subgrupo['Grupo']['nome'], array('controller' => 'grupos', 'action' => 'view', $subgrupo['Grupo']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $subgrupo['Subgrupo']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $subgrupo['Subgrupo']['id']), array('class' => 'btn btn-default btn-xs')); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $subgrupo['Subgrupo']['id']), array('class' => 'btn btn-default btn-xs'), __('Are you sure you want to delete # %s?', $subgrupo['Subgrupo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
					</tbody>
