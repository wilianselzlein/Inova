               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="actions">
                        ...
                        <?php echo $this->Html->link('<i class="fa fa-reddit"></i>',      array('action' => 'contadores',  $user['User']['id']), array('class' => 'btn btn-default btn-xs','title' =>__('Contadores'), 'escape'=>false)); ?>
                        <?php echo $this->Html->link('<i class="fa fa-smile-o"></i>',     array('action' => 'clientes',    $user['User']['id']), array('class' => 'btn btn-default btn-xs','title' =>__('Clientes'), 'escape'=>false)); ?>
                        <?php echo $this->Html->link('<i class="fa fa-eye"></i>',         array('action' => 'view',        $user['User']['id']), array('class' => 'btn btn-default btn-xs','title' => __('View'), 'escape'=>false)); ?>
                        <?php echo $this->Html->link('<i class="fa fa-pencil"></i>',      array('action' => 'edit',        $user['User']['id']), array('class' => 'btn btn-default btn-xs','title' => __('Edit'), 'escape'=>false)); ?>
                        <?php echo $this->Form->postLink('<i class="fa fa-times"></i>',   array('action' => 'delete',      $user['User']['id']), array('class' => 'btn btn-default btn-xs','title' => __('Delete'), 'escape'=>false), __('Are you sure you want to delete # %s?', $user['User']['id'])); ?>
                     </td>
                  </tr>
                  <?php endforeach; ?>
               </tbody>
