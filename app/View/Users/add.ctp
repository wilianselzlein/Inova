		...
		<div class="users form">
			...
			<?php echo $this->Form->create('User', array('role' => 'form')); ?>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
               <?php echo $this->Form->input('ativo', array('type' => 'checkbox', 'class' => 'form-control checkbox2','before'=>'<div class="input"><label>Ativo</label>','after'=>'</div>', 'div'=>false, 'label'=>false, 'checked'=>true)); ?>
            </div><!-- .form-group -->
