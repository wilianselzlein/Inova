						...
						<tr>
							...
							<td class="actions">
								...
								if ((strtolower($usuario_logado['role']) == 'root') || (strtolower($usuario_logado['role']) == 'admin')
									...
									echo $this->Html->link('<i class="fa fa-github-alt"></i>', array('controller'=>'services', 'action' => 'index', $cliente['Cliente']['id'], 'web'=>true), array('class' => 'btn btn-default btn-xs', 'title'=>__('Web'), 'escape'=>false)); 
							}

							?>
							<?php echo $this->Html->link('<i class="fa fa-eye"></i>', array('action' => 'view', $cliente['Cliente']['id']), array('class' => 'btn btn-default btn-xs', 'title'=>__('View'), 'escape'=>false)); ?>
							...
							<?php echo $this->Form->postLink('<i class="fa fa-times"></i>', array('action' => 'delete', $cliente['Cliente']['id']), array('class' => 'btn btn-default btn-xs', 'title'=>__('Delete'), 'escape'=>false), __('Are you sure you want to delete # %s?', $cliente['Cliente']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
