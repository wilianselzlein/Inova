      ...
      <div class="clientes form">
         ...
         <fieldset>
            <div class="form-group">
               <?php echo $this->Form->input('is_ativo', array('type' => 'checkbox', 'class' => 'form-control checkbox2','before'=>'<div class="input"><label>Ativo</label>','after'=>'</div>', 'div'=>false, 'label'=>false, 'checked'=>true)); ?>
            </div><!-- .form-group -->
            <div class="form-group">
            ...
            <div class="form-group">
               <?php $options = array(1 => 'CPF', 2 => 'CNPJ');                    
