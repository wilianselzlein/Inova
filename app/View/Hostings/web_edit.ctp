<div class="panel panel-default">
	<div class="panel-heading">
		<h3>
			<span class="fa fa-cloud"></span> <?php echo __('Edit').' '.__('Hosting'); ?>
	...
	<div class="panel-body">
		...
		<fieldset>
			<div class="form-group">
				<?php echo $this->Form->input('domain_id', array('class' => 'form-control', 'disabled' => true, 'div'=> array('class'=>'col-sm-12'))); ?> 
			</div><!-- .form-group -->
			<div class="form-group">
				<?php echo $this->Form->input('ftp_user', array('class' => 'form-control', 'div'=> array('class'=>'col-sm-4'))); ?>
				<?php echo $this->Form->input('ftp_password', array('class' => 'form-control', 'div'=> array('class'=>'col-sm-4'))); ?>
				<?php echo $this->Form->input('ftp_url', array('class' => 'form-control', 'div'=> array('class'=>'col-sm-4'))); ?>
			</div><!-- .form-group -->
			<div class="form-group">
