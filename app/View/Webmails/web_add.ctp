<div class="panel panel-default">
	<div class="panel-heading">
		<h3>
			<span class="fa fa-envelope"></span> <?php echo __('Add').' '.__('Webmail'); ?>
	...
	<div class="panel-body">
		...
		<fieldset>
			<div class="form-group">
				<?php
				if(isset($hostingDefaults)){
					echo $this->Form->input('hosting_id', array('class' => 'form-control', 'disabled' => true, 'div'=> array('class'=>'col-sm-12')));
					echo $this->Form->hidden('hosting_id', array('value' => $hostingDefaults['id']));
				}else{
					echo $this->Form->input('hosting_id', array('class' => 'form-control', 'div'=> array('class'=>'col-sm-12')));
				}
				 ?>
			</div><!-- .form-group -->
			<div class="form-group">
				<?php echo $this->Form->input('username', array('class' => 'form-control','autofocus' =>true, 'div'=> array('class'=>'col-sm-4'))); ?>
