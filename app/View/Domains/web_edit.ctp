<div class="panel panel-default">
	<div class="panel-heading">
		<h3>
			<span class="fa fa-github-alt"></span> <?php echo __('Edit').' '.__('Domain'); ?>
	...
	<div class="panel-body">
		...
		<fieldset>
			<div class="form-group">
				<?php echo $this->Form->input('customer_id', array('class' => 'form-control combobox','disabled'=>true, 'div'=> array('class'=>'col-sm-10'))); ?>
			</div><!-- .form-group -->
			<div class="form-group">
