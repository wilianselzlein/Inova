<div class="situacaos index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $situacao['Situacao']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $situacao['Situacao']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $situacao['Situacao']['id']), null, __('Are you sure you want to delete # %s?', $situacao['Situacao']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
